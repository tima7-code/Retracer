...
int main()
{
	std::vector<object*> objects = { &sphere(Vector3f( 100,  -50,    0), Vector3f(255, 255, 255), 20, Vector3f(0.0, 1.5, 0.0)),
									 &sphere(Vector3f( 100,  -50,   80), Vector3f( 75,  75, 255), 20, Vector3f(0.8, 0.0, 0.0)),
									 &cube  (Vector3f(-150,  -50,    0), Vector3f(255, 255, 255), 30, Vector3f(0.9, 0.0, 0.0)),
									 &cube  (Vector3f(-330,  -50,    0), Vector3f(255, 255, 255), 30, Vector3f(0.9, 0.0, 0.0)),
									 &cube  (Vector3f(   0,  -50,   90), Vector3f(255, 255, 125), 30, Vector3f(0.0, 0.0, 0.0)),
		                             &plane (Vector3f(   0,    1,    0), Vector3f(125, 125, 125),     Vector3f(0.8, 0.0, 0.0)),
